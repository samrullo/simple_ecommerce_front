...
export const CREATE_PURCHASE_ORDER_FROM_CSV_ENDPOINT=`${API_HOSTNAME}/ecommerce/v1/create-purchase-order-from-csv/`;
...
export const CREATE_PURCHASE_ORDER_ENDPOINT=`${API_HOSTNAME}/ecommerce/v1/create-purchase-order/`
